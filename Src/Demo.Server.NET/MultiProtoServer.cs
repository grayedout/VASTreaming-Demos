...
namespace VAST.Demo
{
    ...
    class MultiProtoServer : IDisposable
    {
        ...
        private void createMixingPublishingPoint1()
        {
            ...
            {
                // TODO: set useFFmpeg to false if you want to utilize NVIDIA hardware acceleration on Linux
                bool useFFmpeg = true;
                source.Parameters.VideoDecoderParameters.PreferredMediaFramework = useFFmpeg ? VAST.Common.MediaFramework.FFmpeg : VAST.Common.MediaFramework.CUDA;
                source.Parameters.VideoDecoderParameters.AllowHardwareAcceleration = true;
                source.Parameters.VideoEncoderParameters.PreferredMediaFramework = useFFmpeg ? VAST.Common.MediaFramework.FFmpeg : VAST.Common.MediaFramework.CUDA;
                source.Parameters.VideoEncoderParameters.AllowHardwareAcceleration = true;
                source.Parameters.AudioDecoderParameters.PreferredMediaFramework = VAST.Common.MediaFramework.FFmpeg;
                source.Parameters.AudioDecoderParameters.AllowHardwareAcceleration = false;
                source.Parameters.AudioEncoderParameters.PreferredMediaFramework = VAST.Common.MediaFramework.FFmpeg;
