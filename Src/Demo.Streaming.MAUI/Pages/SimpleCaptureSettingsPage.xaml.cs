...
namespace VAST.Demo
{
    ...
    /// <summary>
    /// Modal settings page for the simple capture demo.
    /// Contains device selection, encoding parameters, rendering strategy, and server URI configuration.
    /// </summary>
    /// <remarks>
    /// This page is presented modally from <see cref="SimpleCapturePage"/> when the user taps Settings.
    ...
    public partial class SimpleCaptureSettingsPage : ContentPage
    {
        ...
        /// <summary>
        /// Creates a new instance of <see cref="SimpleCaptureSettingsPage"/>.
        /// </summary>
        /// <remarks>
        /// Initializes picker controls with default values:
        /// - Rendering: Low Latency strategy
        /// - Video: Baseline profile, Auto level
        /// - Audio: 44100 Hz sample rate, 2 channels (stereo)
        /// - Encoding framework options differ by platform: Windows offers Media Foundation,
        ///   FFmpeg, and Nvidia; other platforms offer Builtin and FFmpeg.
        /// </remarks>
        public SimpleCaptureSettingsPage()
        {
            ...
            {
                // Windows: Media Foundation (native), FFmpeg (software), Nvidia (GPU)
        ...
        public async Task EnumerateDevices()
        {
            ...
            if (this.videoDevices != null || this.audioDevices != null)
                return;
        ...
        ///
        /// All other settings (encoding parameters, rendering strategy, server URI, checkboxes)
        ...
        /// </remarks>
        public void InitializeFrom(SimpleCaptureSettingsPage other)
        {
